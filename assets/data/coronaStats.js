export default {
  ...
  statesData: [
    { state: 'Lagos', total: 18827, recovered: 15245, death: 205 },
    { state: 'FCT', total: 5540, recovered: 4913, death: 76 },
    { state: 'Kano', total: 1734, recovered: 1655, death: 54 },
    { state: 'Ogun', total: 1758, recovered: 1718, death: 28 },
    { state: 'Osun', total: 810, recovered: 775, death: 17 },
    { state: 'Gombe', total: 799, recovered: 680, death: 25 },
    { state: 'Borno', total: 741, recovered: 703, death: 36 },
    { state: 'Katsina', total: 845, recovered: 457, death: 24 },
    { state: 'Edo', total: 2611, recovered: 2427, death: 105 },
    { state: 'Oyo', total: 3226, recovered: 2102, death: 39 },
    { state: 'Bauchi', total: 689, recovered: 658, death: 14 },
    { state: 'Kwara', total: 1013, recovered: 902, death: 25 },
    { state: 'Akwa Ibom', total: 288, recovered: 264, death: 8 },
    { state: 'Kaduna', total: 2326, recovered: 2205, death: 33 },
    { state: 'Ekiti', total: 313, recovered: 283, death: 6 },
    { state: 'Taraba', total: 95, recovered: 73, death: 6 },
    { state: 'Delta', total: 1799, recovered: 1638, death: 49 },
    { state: 'Ondo', total: 1590	, recovered: 1490, death: 35 },
    { state: 'Rivers', total: 2220, recovered: 2130, death: 59 },
    { state: 'Enugu', total: 1234, recovered: 1166, death: 21 },
    { state: 'Niger', total: 250, recovered: 232, death: 12 },
    { state: 'Jigawa', total: 322, recovered: 308, death: 11 },
    { state: 'Zamfara', total: 78, recovered: 73, death: 5 },
    { state: 'Sokoto', total: 161, recovered: 142, death: 17 },
    { state: 'Abia', total: 881, recovered: 802, death: 8 },
    { state: 'Ebonyi', total: 1035, recovered: 1004, death: 30 },
    { state: 'Benue', total: 473, recovered: 401, death: 9 },
    { state: 'Anambra', total: 232, recovered: 184, death: 19 },
    { state: 'Plateau', total: 3192, recovered: 2275, death: 31 },
    { state: 'Adamawa', total: 230, recovered: 196, death: 15 },
    { state: 'Imo', total: 551, recovered: 216, death: 12 },
    { state: 'Yobe', total: 73, recovered: 59, death: 8 },
    { state: 'Nassarawa', total: 447, recovered: 298, death: 12 },
    { state: 'Kebbi', total: 93, recovered: 84, death: 8 },
    { state: 'Bayelsa', total: 394, recovered: 370, death: 21 },
    { state: 'Kogi', total: 5, recovered: 3, death: 2 },
    { state: 'cross River', total: 85, recovered: 74, death: 9 }
  ],
  helplines: [
